...
const HomeScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    if(locationData?.latitude) {
        ...
        const geoCodeDetails = getGeoCodeAPI(19.119860, 72.883461)
        .then(response => {
    ...
    return (
        <SafeAreaView>
            <MainHeader  location={currentLocation } />
            <ScrollView >
            ...
            <View style={styles.nearBy}>
                ...
                {nearByRestaurant.length === 0 ? <Image
                    ...
                    style={styles.lottie}
                />
                : <RestaurantsNearBy data={nearByRestaurant} navigationData={navigation} /> }
